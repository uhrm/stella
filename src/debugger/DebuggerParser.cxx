...
void DebuggerParser::executeJoy0Up()
{
  ...
  if(argCount == 0)
    controller.set(Controller::One, 1-controller.read(Controller::One));
  else if(argCount == 1)
    controller.set(Controller::One, args[0]);
}
...
void DebuggerParser::executeJoy0Down()
{
  Controller& controller = debugger.riotDebug().controller(Controller::Left);
  if(argCount == 0)
    controller.set(Controller::Two, 1-controller.read(Controller::Two));
  else if(argCount == 1)
    controller.set(Controller::Two, args[0]);
}
...
void DebuggerParser::executeJoy0Left()
{
  Controller& controller = debugger.riotDebug().controller(Controller::Left);
  if(argCount == 0)
    controller.set(Controller::Three, 1-controller.read(Controller::Three));
  else if(argCount == 1)
    controller.set(Controller::Three, args[0]);
}
...
void DebuggerParser::executeJoy0Right()
{
  Controller& controller = debugger.riotDebug().controller(Controller::Left);
  if(argCount == 0)
    controller.set(Controller::Four, 1-controller.read(Controller::Four));
  else if(argCount == 1)
    controller.set(Controller::Four, args[0]);
}
...
void DebuggerParser::executeJoy0Fire()
{
  Controller& controller = debugger.riotDebug().controller(Controller::Left);
  if(argCount == 0)
    controller.set(Controller::Six, 1-controller.read(Controller::Six));
  else if(argCount == 1)
    controller.set(Controller::Six, args[0]);
}
